...
exports.seed = function(knex, Promise) {
  return Promise.all([
    ...
    return Promise.all([
      ...
      knex('relationships').returning('id')
      .insert([
        {
          template_id: templateIds[0]
        },
      ...
      return Promise.all([
        ...
        return Promise.all([
          ...
          knex('pieces').insert([
            ...
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[10],
              field_id: fieldIds[0],
              equality: 'equal',
              number: 3
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[11],
              field_id: fieldIds[1],
              equality: 'equal',
              number: 3
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[12],
              field_id: fieldIds[2],
              equality: 'equal',
              number: 3
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[13],
              field_id: fieldIds[3],
              equality: 'equal',
              number: 3
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[14],
              field_id: fieldIds[4],
              equality: 'equal',
              number: 3
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[15],
              field_id: fieldIds[0],
              equality: 'equal',
              number: 4
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[16],
              field_id: fieldIds[1],
              equality: 'equal',
              number: 4
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[17],
              field_id: fieldIds[2],
              equality: 'equal',
              number: 4
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[18],
              field_id: fieldIds[3],
              equality: 'equal',
              number: 4
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[19],
              field_id: fieldIds[4],
              equality: 'equal',
              number: 4
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[20],
              field_id: fieldIds[0],
              equality: 'equal',
              number: 5
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[21],
              field_id: fieldIds[1],
              equality: 'equal',
              number: 5
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[22],
              field_id: fieldIds[2],
              equality: 'equal',
              number: 5
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[23],
              field_id: fieldIds[3],
              equality: 'equal',
              number: 5
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[24],
              field_id: fieldIds[4],
              equality: 'equal',
              number: 5
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[25],
              field_id: fieldIds[0],
              equality: 'equal',
              number: 1
            },
            ...
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[26],
              field_id: fieldIds[5],
              equality: 'larger-than-equal',
              number: 3
            },
            {
              individual_piece_relationship_id: individualPieceRelationshipIds[27],
              field_id: fieldIds[6],
              equality: 'equal',
              number: 1
            }
